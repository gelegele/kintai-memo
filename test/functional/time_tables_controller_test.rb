...
class TimeTablesControllerTest < ActionController::TestCase
  ...
  test "should create time_table" do
    assert_difference('TimeTable.count') do
      post :create, time_table: { fixed_end_hours: @time_table.fixed_end_hours, fixed_end_minutes: @time_table.fixed_end_minutes, fixed_start_hours: @time_table.fixed_start_hours, fixed_start_minutes: @time_table.fixed_start_minutes }
    end
  ...
  test "should update time_table" do
    put :update, id: @time_table, time_table: { fixed_end_hours: @time_table.fixed_end_hours, fixed_end_minutes: @time_table.fixed_end_minutes, fixed_start_hours: @time_table.fixed_start_hours, fixed_start_minutes: @time_table.fixed_start_minutes }
    assert_redirected_to time_table_path(assigns(:time_table))
  end
